  ...
  return (
    <nav className="bg-gray-200 p-4 flex justify-evenly items-center">
      ...
      <ul className="flex justify-center items-center gap-10 ">
        <li className="text-gray-500 font-bold hover:text-black hover:scale-110 transition-all duration-300">
          <Link to="/">Home</Link>
        </li>
        <li className="text-gray-500 font-bold hover:text-black hover:scale-110 transition-all duration-300">
      ...
      {location.pathname !== "/delete-product" && (
        <button
          ...
          className="px-1 rounded-2xl font-light transition duration-300 ease-in-out  hover:scale-110 hover:bg-indigo-100  border-1 border-gray-500 cursor-pointer flex items-center text-2xl text-sky-500"
        >
          <FaProductHunt />
          Add
        </button>
